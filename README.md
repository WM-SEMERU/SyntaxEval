...
Welcome, in this section you will find instructions to use the library
and evaluate Linguistic Capabilities on Bidirectional Models (BERT)
...
All the data and results in the final project report can be found in the
./scripts folder.
